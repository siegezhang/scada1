...
public class Dalian1Entity {
  private float MH2;
  private float AT;
  private float Pinst_MPa;
  private float Linst;
  private float COSTH2;
  private float AMH2;
  private float Pend_MPa;
  private float P0_MPa;
  private float Ptarget_MPa;
  private float Sjqj35;
  private float WRITEdispenssor;
  private float AMH2_Calculation35;
  private float Pinst_bar;
  private float Pend_bar;
  private float P0_bar;
  private float Ptarget_bar;
  private float Pin450;
  private float Pout450;
  private float Tout450;
  private float Toil450;
  private float Pin450_bar;
  private float Pout450_bar;
  private float BY11;
  private float BY12;
  private float BY13;
  private float Pin900;
  private float Pout900;
  private float Tout900;
