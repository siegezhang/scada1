...
public class YunfuController {
  Gson gson = new Gson();
  @Autowired private YunfuMapper yunfuMapper;
  ...
  public void downloadExcel(
    ...
    String fileName =
        "云浮站数据报表" + start_date.replaceAll("-", "") + "-" + end_date.replaceAll("-", "") + ".xls";
    ExcelUtil.produceExcel(
        fileName, response, list, ExcelConstant.YUNFU_TITLE, ExcelConstant.YUNFU_FIELD);
  }
